...
class TestJsonTranslator(unittest.TestCase):
    ...
    def test_translate(self):
        ...
        translated_dict, x, y = translator.translate("en", "fr")
        self.assertEqual(
    ...
    def test_round_trip(self):
        ...
        translated_dict_round_trip, c, d = translator_round_trip.translate("fr", "en")

        self.assertEquals(translated_dict_round_trip, self.nested_dict)
