...
class ActionHandlerTest(TestCase):
    ...
    def test_info(self):
        ...
        info_response = self.client.post('/v3/testimonials.info', urlencode({"testimonial_id": self.TESTIMONIAL1.id}), content_type="application/x-www-form-urlencoded").toDict()
    ...
    def test_create(self):
        # test not logged in
        signinAs(self.client, None)
        create_response = self.client.post('/v3/testimonials.create', urlencode({"title": "none_logged"}), content_type="application/x-www-form-urlencoded").toDict()
        self.assertFalse(create_response["success"])

        # test logged in as user
        signinAs(self.client, self.USER)
        create_response = self.client.post('/v3/testimonials.create', urlencode({"title": "user_logged"}), content_type="application/x-www-form-urlencoded").toDict()
        self.assertTrue(create_response["success"])
        self.assertEqual(create_response["data"]["title"], "user_logged")

        # test logged in as admin
        signinAs(self.client, self.SADMIN)
        create_response = self.client.post('/v3/testimonials.create', urlencode({"title": "admin_logged"}), content_type="application/x-www-form-urlencoded").toDict()
        self.assertTrue(create_response["success"])
    ...
    def test_list(self):
        # test not logged in
        signinAs(self.client, None)
        list_response = self.client.post('/v3/testimonials.list', urlencode({"user_id": self.SADMIN.id}), content_type="application/x-www-form-urlencoded").toDict()
    ...
    def test_update(self):
        # test not logged in
        signinAs(self.client, None)
        update_response = self.client.post('/v3/testimonials.update', urlencode({"testimonial_id": self.TESTIMONIAL1.id, "is_approved": True}), content_type="application/x-www-form-urlencoded").toDict()
    ...
    def test_delete(self):
        ...
        # test not logged in
        signinAs(self.client, None)
        delete_response = self.client.post('/v3/testimonials.delete', urlencode({"testimonial_id": testimonial.id}), content_type="application/x-www-form-urlencoded").toDict()
    ...
    def test_rank(self):
        # test not logged in
        signinAs(self.client, None)
        rank_response = self.client.post('/v3/testimonials.rank', urlencode({"testimonial_id": self.TESTIMONIAL1.id, "rank": 1}), content_type="application/x-www-form-urlencoded").toDict()
    ...
    def test_cadmin_list(self):
        # test not logged in
        signinAs(self.client, None)
        list_response = self.client.post('/v3/testimonials.listForCommunityAdmin', urlencode({}), content_type="application/x-www-form-urlencoded").toDict()
    ...
    def test_sadmin_list(self):
        # test not logged in
        signinAs(self.client, None)
        list_response = self.client.post('/v3/testimonials.listForSuperAdmin', urlencode({}), content_type="application/x-www-form-urlencoded").toDict()
        self.assertFalse(list_response["success"])
