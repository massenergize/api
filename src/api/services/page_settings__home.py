...
class HomePageSettingsService:
  ...
  def list_home_page_settings(self, home_page_setting_id) -> Tuple[list, MassEnergizeAPIError]:
  ...
  def list_home_page_settings_for_super_admin(self) -> Tuple[list, MassEnergizeAPIError]:
