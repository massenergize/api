...
class ActionsPageSettings(PageSettings):
...
class ContactUsPageSettings(PageSettings):
...
class DonatePageSettings(PageSettings):
...
class AboutUsPageSettings(PageSettings):
...
class ImpactPageSettings(PageSettings):
