...
def community_portal_home_page_data():
  ...
  """
  return common.json_loader('./database/demo-data/community-portal/homePageData.json')

def community_portal_website_menu():
  """
  Returns the menu for communty portal 
  """
  return common.json_loader('./database/demo-data/community-portal/menu.json')

def community_portal_actions(community_id='default'):
  """
  Returns all the possible actions for a community actions 
  """
  return common.json_loader('./database/demo-data/community-portal/actionsPageData.json')
