...
urlpatterns = [
  ...
  path('media', media),
  path('media/<int:id>', media),
  path('media/<slug:id>', media),
  path('menu', menu),
  ...
  path('statistic/<int:id>', statistic),
  ...
  path('user/<int:id>/households', user_households),
  path('user/<int:id>/household/<int:household_id>/actions', user_household_actions),
  path('user/<int:id>/actions', user_actions),
  path('user/<int:id>/teams', user_teams),
