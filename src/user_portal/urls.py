...
urlpatterns = [
  ...
  path('get/community_graph', views.get_one_community_graph),
  path('get/community_graphs', views.get_community_graphs),
  path('get/community_graphs/all', views.get_community_graphs),
